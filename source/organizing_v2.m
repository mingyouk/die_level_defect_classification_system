...
% Uncomment the one not required
...
if (isempty(score1))
    ...
    cd (resultDir);
    imwrite(detectedImg, [file, '_', char(label(idx)), '_all_box.png'], 'png'); 
    fprintf('%s\n', label(idx)); 
    ...
    imwrite(detectedImg, [file, '_', char(label(idx)), '_1box.png'], 'png'); 
    fprintf('%s\n', label(idx)); 
